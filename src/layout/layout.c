...
void error_from_layout_errors(char *buff, size_t buff_size, LayoutErrors error){
    switch(error){
    case LAYOUT_INFO_LOCATION_NOT_FOUND: snprintf(buff, buff_size, "%s", LAYOUT_INFO_LOCATION_NOT_FOUND_MSG); break;
    case LAYOUT_REQUEST_ERROR: snprintf(buff, buff_size, "%s", LAYOUT_REQUEST_ERROR_MSG); break;
    case LAYOUT_LOCATION_DONT_EXIST: snprintf(buff, buff_size, "%s", LAYOUT_LOCATION_DONT_EXIST_MSG); break;
    case LAYOUT_REQUEST_TIMEOUT: snprintf(buff, buff_size, "%s", LAYOUT_REQUEST_TIMEOUT_MSG); break;
    case LAYOUT_NO_INTERNET: snprintf(buff, buff_size, "%s", LAYOUT_NO_INTERNET_MSG); break;
    case LAYOUT_GENERIC_ERROR: snprintf(buff, buff_size, "%s", LAYOUT_GENERIC_ERROR_MSG); break;
    default: snprintf(buff, buff_size, "%s", LAYOUT_GENERIC_ERROR_MSG); break;
  }
}
...
void image_path_from_layout_errors(char *buff, size_t buff_size, LayoutErrors error){
    switch(error){
    case LAYOUT_INFO_LOCATION_NOT_FOUND: snprintf(buff, buff_size, "%s", LAYOUT_INFO_LOCATION_NOT_FOUND_IMAGE_PATH); break;
    case LAYOUT_REQUEST_ERROR: snprintf(buff, buff_size, "%s", LAYOUT_REQUEST_ERROR_IMAGE_PATH); break;
    case LAYOUT_LOCATION_DONT_EXIST: snprintf(buff, buff_size, "%s", LAYOUT_LOCATION_DONT_EXIST_IMAGE_PATH); break;
    case LAYOUT_REQUEST_TIMEOUT: snprintf(buff, buff_size, "%s", LAYOUT_REQUEST_TIMEOUT_IMAGE_PATH); break;
    case LAYOUT_NO_INTERNET: snprintf(buff, buff_size, "%s", LAYOUT_NO_INTERNET_IMAGE_PATH); break;
    case LAYOUT_GENERIC_ERROR: snprintf(buff, buff_size, "%s", LAYOUT_GENERIC_ERROR_IMAGE_PATH); break;
    default: snprintf(buff, buff_size, "%s", LAYOUT_GENERIC_ERROR_IMAGE_PATH); break;
  }
...
GtkWidget *layout_page_error(WeatherUI *ui){
  ...
  GtkWidget *error_image = gtk_image_new_from_file("../assets/generic-error.png");
...
void show_error_page(WeatherUI *ui, LayoutErrors error){
    ...
    gtk_image_set_from_file(ui->error_image, image_path);
